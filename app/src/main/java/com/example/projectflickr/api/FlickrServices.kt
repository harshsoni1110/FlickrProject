...
interface FlickrServices{
    ...
    @GET("rest/")
    fun fetchList(@Query("tags") tags: String, @Query("method") method: String = "flickr.photos.search", @Query("per_page") per_page:Int = 10) : LiveData<ApiResponse<PhotoResponse>>
